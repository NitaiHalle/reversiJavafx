...
public class ReversiGameController implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		info.getChildren().add(new Text("turn : "+ this.ControllerBoard.getCurrentPlayer()));
		info.getChildren().add(new Text("score player1:"+ this.ControllerBoard.getScoreP1()));
		info.getChildren().add(new Text("score player2:"+ this.ControllerBoard.getScoreP2()));
		this.startNewGame();
